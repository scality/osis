...
public class VaultAdminBuilder {
   ...
   */
  public VaultAdminBuilder accessKey(String accessKey) {
   ...
   * @return This object for method chaining.
   */
  public VaultAdminBuilder secretKey(String secretKey) {
   ...
   * @return This object for method chaining.
   */
  public VaultAdminBuilder endpoint(String endpoint) {
